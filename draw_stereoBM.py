...
out_dir = 'outputs/outputs_stereoBM/'
...
for img_name in tqdm(sorted(ls)):
  ...
  imgL = cv2.imread(img_dir + 'image_2/' + img_name, cv2.IMREAD_GRAYSCALE)
  imgR = cv2.imread(img_dir + 'image_3/' + img_name, cv2.IMREAD_GRAYSCALE)
